@extends('layout.overall')

@section('content')
    <div class="pt-24">
        <img class="w-full lg:block hidden top-0 absolute" src="{{ asset('img/waves2.svg') }}" alt="Header"/>
        <div class="relative container px-3 mx-auto flex flex-wrap flex-col md:flex-row items-center">
            <!--Left Col-->
            <div class="flex flex-col lg:text-white w-full md:w-2/5 justify-center items-start text-center md:text-left">
            ...
            <div class="w-full md:w-3/5 py-6 text-center">
                <img class="w-full md:w-4/5 z-50 float-right" src="https://compass-ssl.microsoft.com/assets/ea/78/ea782c84-96a1-4609-8562-77fa5127b185.png?n=ioc_home_bottomright_4up_491x276.png" />
            </div>
        </div>
    </div>
    <section class="bg-white border-b py-8 lg:mt-48">
            ...
            <div class="w-full md:w-1/3 p-6 flex flex-col flex-grow flex-shrink">
                ...
                <div class="flex-none mt-auto bg-white rounded-b rounded-t-none overflow-hidden shadow p-6">
                    <div class="flex items-center justify-center">
                        <button class="lg:bg-gradient-to-r from-red-500 to-orange-500 text-white rounded-xl mx-auto lg:mx-0 hover:underline gradient text-white font-bold rounded-full my-6 py-4 px-8 shadow-lg focus:outline-none focus:shadow-outline transform transition hover:scale-105 duration-300 ease-in-out">
                            Action
                        </button>
                    </div>
                </div>
